            ...
            <div className="bg-[#1a1a1f] rounded-2xl p-6">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="relative">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center overflow-hidden">
                    {/* 1. T'akkdi l-Avatar kiy-khdem b state 'avatarUrl' */}
                    <Avatar
                      src={
                        avatarUrl ||
                  ...
                  {/* 2. L-icon sghira t9der hta hiya t-cliqua bach t-uploadi */}
                  <label
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {/* 4. Button 'Change Avatar' kiy-trigger l-input l-mkhbi */}
                    <button
                      onClick={() =>
                        document.getElementById("avatar-upload")?.click()
                      }
                      className="px-4 py-1.5 bg-[#2a2a2f] border border-gray-700 rounded-lg text-sm font-medium text-white hover:bg-[#3a3a3f] transition"
                    >
                      Change Avatar
                    </button>

                    {/* 5. Button 'Remove' kiy-dir l-delete */}
                    <button
                      onClick={handleRemoveAvatar}
                      className="px-4 py-1.5 text-sm font-medium text-orange-400 hover:text-orange-300 transition"
                    >
                      Remove
                    </button>
                  </div>
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-violet-600 text-white rounded-xl text-sm font-medium hover:bg-violet-700 transition"
                >
                  Save Profile
                </button>
              </div>
